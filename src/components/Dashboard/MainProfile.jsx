...
const MainProfile = () => {
    return (
        <div className='flex flex-col justify-between h-full'>
            ...
            <div className="bg-white  my-5 flex flex-col gap-2  max-w-[400px]  border-2  border-solid shadow-2xl   relative px-8 p-5 rounded-xl">
            ...
            <div className="bg-white flex flex-col gap-2  max-w-[400px]  border-2  border-solid shadow-2xl   relative px-8 p-5 rounded-xl">
