        ...
        <div>
            <div className='flex md:flex-row flex-col mx-10 min-h-[40vh] justify-between items-center '>
                <div className='text-black max-md:text-center min-h-[35vh] flex flex-col justify-between'>
                    <h1 className='font-medium text-xl text-[#3E66DF]   md:text-3xl'>
                    ...
                    <h1>
                        <button onClick={() => document.getElementById('my_modal_3').showModal()}  className='text-[#3E66DF] gap-3 place-content-center place-items-center max-md:w-[90%] max-md:mx-auto text-center flex justify-center items-center  underline'>
