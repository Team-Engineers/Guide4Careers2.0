  ...
  return (
    <div className="relative flex flex-col justify-center h-fit pt-[5rem]  min-h-[50rem]  ">
      ...
      <div className="relative z-10 h-full">
        <div className="flex justify-center items-center cstmr:h-[35rem]  mx-12 cstmr:max-h-[35rem]">
      ...
      {/* Wave Background */}
      <img src={wavyBackground} className="absolute bottom-0 w-full" />
    </div>
  );
};
