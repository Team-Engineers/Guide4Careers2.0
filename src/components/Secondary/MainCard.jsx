    ...
    return (
        ...
        >
            <div className="flex  justify-center gap-2 px-8 items-center">
                ...
                <p className="flex text-base font-medium items-center justify-start"> <img src={tick} alt="" /> {points1}</p>
                <p className="flex text-base  font-medium "> <img src={tick} alt="" /> {points2}</p>
                <p className="flex text-base  font-medium "> <img src={tick} alt="" /> {points3}</p>
            <h className="flex  text-base  font-medium  justify-center items-center gap-4"><p className="text-base  font-medium ">{footer}</p> <p><FaArrowRight/></p></h>
        </div>
    );
}
